 ...
 */
package com.elmandarin.listlatamsrclib.securepreferences;

import android.content.Context;
import android.content.SharedPreferences;
import android.util.Base64;

import com.elmandarin.listlatamsrclib.securepreferences.crypto.Cryptor;
import com.elmandarin.listlatamsrclib.securepreferences.crypto.HashSHA;
...
public final class SecurePreferences implements SharedPreferences {
    ...
    public final class Editor implements SharedPreferences.Editor {
        ...
        @Override
        public Editor putString(String key, String data) {
        ...
        @Override
        public Editor putInt(String key, int data) {
            String hashedKey = generateKeyHash(key);
        ...
        @Override
        public Editor putLong(String key, long data) {
            String hashedKey = generateKeyHash(key);
        ...
        @Override
        public Editor putFloat(String key, float data) {
            String hashedKey = generateKeyHash(key);
        ...
        @Override
        public Editor putBoolean(String key, boolean data) {
            String hashedKey = generateKeyHash(key);
